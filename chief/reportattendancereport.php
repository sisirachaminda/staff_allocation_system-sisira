...
if(isset($_POST['btn_add'])){
	...
	if($nr1<=$nr2){
		echo "<script>
					window.location.href = 'tcpdf/reports/attendancereport.php?st=".$nr1."&ed=".$nr2."';
			</script>";
		...
		echo "<script>
				...
				window.location.href = 'reportattendancereport.php';
		</script>";
            ...
            <fieldset>
              <div class="form-row">
				...
				<div class="col-md-4 mb-3">
				  ...
				  <input type='date' class='form-control' name='stdte' required>
                </div>
			  ...
			  <div class="form-row">
				...
				<div class="col-md-4 mb-3">
                  <label for="validationTooltip01">End Date</label>
					 <input type='date' class='form-control' name='eddte' required>
                </div>
			  ...
			  <div class="form-row">
				...
				<div class="col-md-4 mb-3">
					<button type="submit" class="btn btn-success btn-block" name="btn_add">Report Generate</button>  
				</div>
			   </div>
            </fieldset>
			</form>  
