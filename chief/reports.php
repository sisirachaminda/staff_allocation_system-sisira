						...
						?>
							...
							<div class="row">
							  <div class="col-sm-12 col-lg-4 mt-4">
								<a href="tcpdf/reports/examinerlist.php"><button type="button" class="btn btn-primary raised-button"><span class="btnText">Examiner List</span></button></a>
							  </div>
							  <div class="col-sm-12 col-lg-4 mt-4">
								<a href="tcpdf/reports/marking_progrss.php"><button type="button" class="btn btn-success raised-button"><span class="btnText">Marking Progress</span></button></a>
							  </div>
							  <div class="col-sm-12 col-lg-4 mt-4">
								<a href="reportattendancereport.php"><button type="button" class="btn btn-danger raised-button"><span class="btnText">Attendance Report</span></button></a>
							  </div>
							</div>
