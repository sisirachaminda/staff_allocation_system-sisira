                    ...
                    <div class="row mt-2">
								<div class="table-responsive">
									<table class='table pending'>
										<tbody>
										<?php
										$select1 = "SELECT * FROM panelmessage WHERE year1='$cdyear' AND (target='All' OR target='$ses_panelno') ORDER BY date DESC";
										$result1 = $conn->query($select1);
										while($row1 = $result1->fetch_assoc()) {
										?>
											<tr>
												<td style="font-weight:bold;background-color:green;color:#ffffff"> <?php echo $row1['date']; ?> -- &nbsp;&nbsp;&nbsp;Management Message -- &nbsp;&nbsp;&nbsp;<?php echo $row1['message'] ?></td>
											</tr>
										<?php
										}
										?>
