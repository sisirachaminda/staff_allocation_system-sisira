...
if(isset($_POST['btnapprove1'])) {
	
	if ($stmt = $conn->prepare("UPDATE basicdetails SET principleApproveStatus=1
	...
	<div class="row">
        ...
        <div class="col col-12">
			  	<div class="title">
												...
												<div class="accordion-body">
													...
													<div class="form-row">
														<div class="col-md-6 mb-3">
															...
															<input class="form-control" type="text" name="Grade_degree" id="Grade_degree" value="<?php echo $bn5; ?>" readonly />
														</div>
														<div class="col-md-6 mb-3">
					...
					<form name="f5" method="post">
						<div class="form-row">
							<div class="col-md-12 mb-12">
								<input type="submit" class="btn btn-Success btn-block btn-lg" name="btnapprove1" value="Appove">
							</div>
						</div>
					</form>
					<br>
					...
					<div class="form-row">
						<div class="col-md-12 mb-12">
							<label for="pvdDetails">Reject Reason:</label>
							<textarea class="form-control" name="rejectreson" required></textarea>
						</div>
					</div>
					<br>
					<div class="form-row">
						<div class="col-md-12 mb-12">
							<input type="submit" class="btn btn-danger btn-block btn-lg" name="btnreject" value="Reject">
						</div>
					</div>
					</form>
