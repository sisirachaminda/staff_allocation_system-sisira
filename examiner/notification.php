						...
						?>
								<div class="row">
									...
									<table class='table pending'>
										<tbody>
											<tr>
												<td style="font-weight:bold;background-color:red;color:#ffffff"> No New Notification</td>
											</tr>
										</tbody>
									</table>
								</div>
							...
							?>
								<div class="row">
									...
									<table class='table pending'>
										<tbody>
											<tr>
												<td style="font-weight:bold;background-color:red;color:#ffffff"> Incomplete Application</td>
											</tr>
										</tbody>
									</table>
								</div>
