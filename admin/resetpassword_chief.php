...
if(isset($_POST['btn_resetpws'])){
	...
	if ($stmt = $conn->prepare("UPDATE chiefdetails SET password='$defpass' WHERE id='$nr1'")) {
		$stmt->execute();
		echo "<script>
              ...
              <div class="form-row">
				...
				<div class="col-md-6 mb-3">
                  ...
                  <select class='form-control' name="user" id="user">
				   ...
				   <?php
					  $sel1="";
					  $select1 = "SELECT * FROM chiefdetails WHERE year1='$cdyear'";
					  $result1 = $conn->query($select1);	
					  while($row1=$result1->fetch_assoc()) {
						$sel1 = $sel1."<option value='" .$row1['id']."'>" . $row1['nic'] ." - ". $row1['initialName'] . "</option>";
					  }
