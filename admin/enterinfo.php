        ...
        <section class="multi_step_form">  
          <form method ="post" id="msform" enctype="multipart/form-data" > 
            ...
            <fieldset>
			  ...
			  <div class="form-row">
                <div class="col-md-6 mb-3">
                  <label for="validationTooltip01">Allocation Period - Start Date</label>
				...
				<div class="col-md-6 mb-3">
                  <label for="validationTooltip01">Allocation Period - End Date</label>
