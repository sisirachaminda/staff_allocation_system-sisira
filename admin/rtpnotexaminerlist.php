...
if(isset($_POST['btn_add'])){
	...
	echo "<script>
				window.location.href = 'tcpdf/reports/notselectedexaminerlist.php?su=".$nr1."&me=".$nr2."';
		</script>";
}
      ...
      <article>
        ...
        <section class="multi_step_form">  
          <form method ="post" enctype="multipart/form-data" > 
            <!-- Tittle -->
            <div class="tittle">
              <h1>Not Selected Examiner List </h1>
            ...
            <fieldset>
			  ...
			  <div class="form-row">
				...
				<div class="col-md-4 mb-3">
                  <label for="validationTooltip01">Medium</label>
