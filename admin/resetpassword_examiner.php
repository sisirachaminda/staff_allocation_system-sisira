...
?>
<?php
if(isset($_POST['btn_resetpws'])){
	$nr1=$_POST['user'];
	
	$defpass=MD5(123);

	if ($stmt = $conn->prepare("UPDATE examiner SET password='$defpass' WHERE id='$nr1'")) {
		$stmt->execute();
		echo "<script>
            ...
            <fieldset>
              <div class="form-row">
				...
				<div class="col-md-6 mb-3">
                  <label for="validationTooltip01">Select User</label>
                  <select class='form-control' name="user" id="user">
					
				   <?php
					  $sel1="";
					  $select1 = "SELECT * FROM examiner INNER JOIN basicdetails ON examiner.id=basicdetails.examiner_id";
					  $result1 = $conn->query($select1);	
					  while($row1=$result1->fetch_assoc()) {
						$sel1 = $sel1."<option value='" .$row1['examiner_id']."'>" . $row1['nic'] ."-". $row1['initialName'] ."</option>";
					  }
					  
					   echo "<option value='' disabled selected hidden>Select User.............</option>";
					   echo $sel1;
              ...
              <button type="submit" class="btn btn-success" name="btn_resetpws">Reset password</button>  
            </fieldset>
			<!-- .................................................................................................................................-->
			<br>
			<br>
