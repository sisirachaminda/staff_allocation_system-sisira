...
if($_GET['me']=="All"){
		...
		public function Header() {
			...
			$this->SetFont('times', 'B', 20);
				...
				$html ='<table border="0">
								...
								$html.='<tr>
											<td width="100%"><h5 align="center" style="color:#001f4d;font-size:18px">Cheif Examiner List</h5> </td>
										</tr>';
								$html.='<tr>
	...
	$pdf->SetTitle('Cheif Examiner List Report');
	...
	$html.='<tbody>';
			$html.='
				<tr style="background-color:#3b4e87;color:#ffffff;font-size:16px">
					...
					<td width="8%" align="center">Mobile No</td>
					<td width="15%" align="center">Email</td>
				</tr>';	

			if($_GET['su']=='All' && $_GET['me']=='All'){
				$select2 = "SELECT * FROM markingcenters INNER JOIN chiefdetails ON markingcenters.panelNo=chiefdetails.panelno
																ORDER BY markingcenters.panelNo ASC";
			}
            ...
            while($row2 = $result2->fetch_assoc()) {
                ...
                $html.='<tr style="font-size:16px">
					...
					$html.='<td width="8%"> '.$row2['mobilephone'].'</td>';
					$html.='<td width="15%"> '.$row2['email'].'</td>';
...
$pdf->Output('Cheif Examiner_List_'.$_GET['su'].'_'.$mediumr.'.pdf', 'I');
